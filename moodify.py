...
def create_playlist(sp, selected_tracks_uri, mood, mood_string):

	print("...creating playlist")
	user_all_data = sp.current_user()
	user_id = user_all_data["id"]

	playlist_all_data = sp.user_playlist_create(user_id, "moodify " + mood_string)
	playlist_id = playlist_all_data["id"]
	playlist_url = ""
	# playlist_uri = playlist_all_data["uri"]
	print('playlist url-----------')
	print(playlist_all_data['external_urls'])

	try:
		playlist_url = playlist_all_data['external_urls']['spotify']

	except:
		playlist_url = playlist_all_data["uri"]
